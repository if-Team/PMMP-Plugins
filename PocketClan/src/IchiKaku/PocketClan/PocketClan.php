...
class PocketClan extends PluginBase implements Listener {
             ...
             case "clan":
                 ...
                 switch($args[0]) {
                     case "make":
                         ...
                         if($this->api->myMoney($p) < $this->setting["money"]) $sp->sendMessage("[PocketClan] You don't have enough money");
    ...
    public function makeClan($maker, $name, $type = "default") {
        if($maker instanceof Player) {
            $this->api->reduceMoney($maker->getName(), 30000);
