...
class OnlyASCII extends PluginBase implements CommandExecutor, Listener {
	public function onEnable() {
		...
		$this->config = (new Config ( $this->getDataFolder () . "config.yml", Config::YAML, array ("Enable" => "true","Announce1" => "This server only support ASCII Code","Announce2" => "Please using english or special letters" ) ))->getAll ();
