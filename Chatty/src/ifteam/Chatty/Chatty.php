...
class Chatty extends PluginBase implements Listener {
    ...
    public function onEnable(){
        ...
        $this->packets["AddPlayerPacket"]->metadata = [
            ...
            Entity::DATA_AIR => [Entity::DATA_TYPE_SHORT, 20],
            Entity::DATA_SHOW_NAMETAG => [Entity::DATA_TYPE_BYTE, 1]
        ];

        $this->registerCommand($this->getMessage("chatty-command-name"), "Chatty.commands", $this->getMessage("chatty-command-description"), $this->getMessage("chatty-command-usage"));
