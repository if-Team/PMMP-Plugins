...
class StartDASH extends PluginBase implements Listener {
	...
	public function onQuit(PlayerQuitEvent $event) {
		$player = $event->getPlayer ();
		if (isset ( $this->past [$player->getName ()] )) unset ( $this->past [$player->getName ()] );
		if (isset ( $this->past_q [$player->getName ()] )) unset ( $this->past_q [$player->getName ()] );
	}
