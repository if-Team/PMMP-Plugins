...
class namingCaution extends PluginBase implements Listener {
	...
	public function onEnable() {
		...
		$this->listyml = new Config ( $this->getDataFolder () . "list.yml", Config::YAML, array ("message" => "[CAUTION] You can't use this username\nKicking processed automatically...\nWhen you change your username, you can play.","names" => array () ) );
